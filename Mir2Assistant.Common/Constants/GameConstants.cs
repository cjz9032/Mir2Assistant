...
public static class GameConstants
{
    ...
    public static class Skills
    {
        ...
        public const int RecallDogSpellId = 30;
...
// 自动生成的技能消耗MP映射
    public static readonly Dictionary<int, int> MagicSpellMap = new()
    {
        ...
        { 10, 30 }, { 11, 12 }, { 12, 0 }, { 13, 5 }, { 14, 15 }, { 15, 15 }, { 16, 10 }, { 17, 16 }, { 18, 5 },
        { 19, 10 }, { 20, 3 }, { 21, 10 }, { 22, 20 }, { 23, 15 }, { 24, 35 }, { 25, 0 }, { 26, 0 }, { 27, 15 },
        { 28, 16 }, { 29, 12 }, { 30, 16 }, { 31, 20 }, { 32, 50 }, { 33, 12 }
    };

// 自动生成的技能防御消耗MP映射
    public static readonly Dictionary<int, int> MagicDefSpellMap = new()
    {
        { 1, 1 }, { 2, 0 }, { 3, 0 }, { 4, 0 }, { 5, 5 }, { 6, 0 }, { 7, 0 }, { 8, 0 }, { 9, 10 },
        { 10, 30 }, { 11, 6 }, { 12, 0 }, { 13, 2 }, { 14, 0 }, { 15, 0 }, { 16, 5 }, { 17, 8 }, { 18, 0 },
        { 19, 0 }, { 20, 3 }, { 21, 8 }, { 22, 25 }, { 23, 10 }, { 24, 20 }, { 25, 3 }, { 26, 7 }, { 27, 0 },
        { 28, 0 }, { 29, 25 }, { 30, 24 }, { 31, 30 }, { 32, 40 }, { 33, 30 }
    };
    ...
    public static readonly string[] allowMonsters = new string[]  {   "食人花", "虎蛇" , "红蛇","半兽战士", "蝎子"
            , "洞蛆", "蝙蝠", "骷髅", "骷髅战将", "掷斧骷髅", "骷髅战士", "骷髅精灵", "僵尸","山洞蝙蝠", "尸王", "牛头魔","牛头侍卫","牛魔战士","牛魔斗士",
            "牛魔将军","牛魔祭司","牛魔法师","宝箱",
        "红野猪", "黑野猪", "楔蛾", "蝎蛇", "角蝇","白野猪","半兽勇士","恶灵僵尸","恶灵尸王","骷髅弓箭手","骷髅长枪兵","骷髅刀斧手",
    ...
    public static class Items
    {
        ...
        public static readonly double commonHideRate = 0.6;
        ...
        public static readonly FrozenSet<string> JPSetFrozen =
            new[] { "祝福油", "山洞凭证", "半月弯刀", "困魔咒", "烈火剑法", "召唤神兽", "冰咆哮", "地狱雷光","鹤嘴锄",
                "魔法盾", "火墙", "群体治疗术", "刺杀剑术", "野蛮冲撞", "圣言术", "极速神水","体力强效药水","魔力强效药水", "战神油"
                ,"魔杖"
